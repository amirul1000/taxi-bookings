...
<h5 class="font-20 mt-15 mb-1"><?php if($id<0){echo "Save";}else { echo "Update";} echo " "; echo str_replace('_',' ','Staff'); ?></h5>
<!--Form to save data-->
        ...
        ?> 
          <select name="country_id" id="country_id" class="form-control" />
            ...
            <option value="<?=$dataArr[$i]['id']?>"
					<?php if($users['country_id']==$dataArr[$i]['id']){ echo "selected";} ?>><?=$dataArr[$i]['country']?></option> 
            <?php
            }
            ?> 
          </select>
           ...
           <select name="user_type" id="user_type" class="form-control" />
            ...
            for ($i = 0; $i < count($enumArr); $i ++) {
             ...
             <option value="<?=$enumArr[$i]?>"
					<?php if($users['user_type']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php
            }
            ?> 
           </select>
        ...
        ?> 
           <select name="status" id="status" class="form-control" />
            ...
            for ($i = 0; $i < count($enumArr); $i ++) {
                ?> 
             <option value="<?=$enumArr[$i]?>"
					<?php if($users['status']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php
            }
            ?> 
           </select>
