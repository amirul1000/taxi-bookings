...
class Customers extends CI_Controller
{
    ...
    function save($id = - 1)
    {
        ...
        $params = array(
            ...
            'postcode' => html_escape($this->input->post('postcode')),
            'home_telephone' => html_escape($this->input->post('home_telephone')),
            'mobile_mumber' => html_escape($this->input->post('mobile_mumber')),
    ...
    function search($start = 0)
    {
        ...
        $this->db->or_like('postcode', $key, 'both');
        $this->db->or_like('home_telephone', $key, 'both');
        $this->db->or_like('mobile_mumber', $key, 'both');
